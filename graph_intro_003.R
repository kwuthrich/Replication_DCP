...
setwd("/Users/kasparwuthrich/Dropbox/research/SC/SC with Victor and Yinchu/Conformal QR and DR/")
...
graphics.off()
pdf("code/graphics/picture_intro_length.pdf", pointsize=14,width=6.0,height=6.0)
...
graphics.off()
pdf("code/graphics/picture_intro_coverage.pdf", pointsize=14,width=6.0,height=6.0)
