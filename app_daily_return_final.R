...
save.image(file=paste("return",format(Sys.time(),"%Y-%m-%d_%T"),".RData",sep=""))
...
graphics.off()
pdf("conditional_coverage_returns.pdf",pointsize=22,width=16.0,height=9.0)
...
graphics.off()
pdf("conditional_length_returns.pdf",pointsize=22,width=16.0,height=9.0)
